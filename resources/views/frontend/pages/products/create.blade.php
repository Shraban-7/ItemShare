        ...
        <div class="col-md-8">
            <div class="card mt-4">
                <div class="card-header">
                    <h2 class="text-center">{{ __('Create Product') }}</h2>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rental_fee" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block mt-4">Create Product</button>
                    </form>
                </div>
            </div>
        </div>
