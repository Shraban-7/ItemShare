                    ...
                    <tbody>
                        @foreach ($bookings as $booking)
                            <tr>
                                ...
                                <td class="text-center align-middle">{{ $booking->end_date }}</td>
                                @if ($booking->status === 0)
                                    <td>-</td>
                                ...
                                <td>
                                    <div>
                                        <select class="form-select statusSelect" name="status"
                                            ...
                                            <option value="1" {{ $booking->status == 1 ? 'selected' : '' }}>Approved
                                            </option>
                                            <option value="2" {{ $booking->status == 2 ? 'selected' : '' }}>Cancelled
                                            </option>
                                        </select>
                                    </div>
                                </td>
